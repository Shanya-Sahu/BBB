    ...
    <div>
        ...
        <div className="m-5 bg-white p-5 border-2 rounded-md">
         ...
         <div className='flex justify-between'>
          ...
          <div className='relative cursor-pointer mr-10'>
            <div className="profile-pic rounded-full bg-white p-2 shadow-xl w-[150px] h-[150px] relative bottom-14 left-5">
                <img src="https://dreamspos.dreamguystech.com/html/template/assets/img/customer/customer5.jpg" alt="profile-img" className='rounded-full w-full' />
            <AiOutlineCloudUpload className='absolute top-24 left-16 text-4xl text-white bg-[var(--primary-color)] rounded-full p-2'/>
            </div>
            
            <input type="file" id="imgInp" className='absolute top-0 invisible w-[150px] h-[150px] rounded-full z-10 left-5'  />
        ...
        <p>Updates Your Photo and Personal Details.</p>
         ...
         <form className='w-full flex justify-between items-center flex-wrap -mt-10'> 
          ...
          <label htmlFor="" className='text-sm'>First Name</label><br />
          <input type="text" className='p-1 border-2 rounded-md w-full' required/>
          </div>

         <div className='w-[49%] my-3'>
          <label htmlFor="" className='text-sm'>Last Name</label><br />
          <input type="text" className='p-1 border-2 rounded-md w-full' required/>
          </div>
          ...
          <div className='w-[49%] my-3'>
          <label htmlFor="" className='text-sm'>Username</label><br />
          <input type="text" className='p-1 border-2 rounded-md w-full' required/>
          </div>

          <div className='w-[49%] my-3'>
          <label htmlFor="" className='text-sm'>Password</label><br />
          <input type="password" className='p-1 border-2 rounded-md w-full' required/>
          </div>
